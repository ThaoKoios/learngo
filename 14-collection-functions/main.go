...
In some languages it is idiomatic to use generic data structures and algorithms.
Go does not support generics; in Go it is common to provide collection functions if and when they are specifically needed
