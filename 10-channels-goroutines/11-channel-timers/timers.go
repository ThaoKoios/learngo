...
func main() {
	/*
		...
		The following timer will wait 2 seconds.
	*/
	...
	One reason a timer may be usefull is that you can cancel the timer before it expires.
...
// RESULTS: the first timer will expire ~2s after we start the program, but the second should be stopped before it has a chance to expire
