/*
Rale limiting is an important mechanism for controlling resource utilization and maintaining quality of service.
Go elengantly suppoerts rate limiting with goroutine, channels and tickers.
*/
...
func main() {
	...
	/* First we will look at basic rate limiting.
