...
// We will use these two structs to demonstrate encoding and decoding of custom types below
...
func main() {
	// First we will look at encoding basic data types to JSON strings.
	...
	// In order to use the values in the decoded map, we will need to convert them to their appropriate type.
	...
	// In the examples above we always used bytes and strings as intermediates between the data and JSON representation on
	// standard out. We can also stream JSON encoding directly to 'os.Writers' like 'os.Stdout' or even HTTP response bodies
