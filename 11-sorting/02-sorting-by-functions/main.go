...
Here is an example of custom sorts in Go.
*/
...
Here we have created a 'byLength' type that is just an alias for the builtin '[]string' type.
*/
...
// After running, the program shows a list sorted by string length, as desired
